...
DB_URII = "mongodb+srv://gocowit135:Spicy143@cluster0.xxr1zr6.mongodb.net/?appName=Cluster0"
...
class Rohit:
    ...
    def __init__(self, DB_URII, DB_NAME):
        self.dbclient = motor.motor_asyncio.AsyncIOMotorClient(DB_URII)
