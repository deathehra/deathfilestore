...
async def batch(client: Client, message: Message):
    ...
    await second_message.reply_text(f"<blockquote><b>ʂթɨƈꪗ</b></blockquote>\n\n"f"<blockquote><b>Here is your link:</b>\n\n{link}</blockquote>", quote=True)
...
async def link_generator(client: Client, message: Message):
    ...
    link = f"https://t.me/{client.username}?start={base64_string}"
    await channel_message.reply_text(f"<blockquote><b>ʂթɨƈꪗ</b></blockquote>\n\n"f"<blockquote><b>Here is your link:</b>\n\n{link}</blockquote>", quote=True)
...
async def custom_batch(client: Client, message: Message):
    ...
    await message.reply(f"<blockquote><b>ʂթɨƈꪗ</b></blockquote>\n\n"f"<blockquote><b>Here is your custom batch link:</b>\n\n{link}</blockquote>", quote=True)
